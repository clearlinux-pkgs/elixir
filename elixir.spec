...
Source0  : https://github.com/elixir-lang/elixir/archive/v1.15.4/elixir-1.15.4.tar.gz
...
%prep
%setup -q -n elixir-1.15.4
cd %{_builddir}/elixir-1.15.4
pushd ..
cp -a elixir-1.15.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1689691452
