...
Version  : 1.18.4
Release  : 38
URL      : https://github.com/elixir-lang/elixir/archive/v1.18.4/elixir-1.18.4.tar.gz
Source0  : https://github.com/elixir-lang/elixir/archive/v1.18.4/elixir-1.18.4.tar.gz
...
%prep
%setup -q -n elixir-1.18.4
cd %{_builddir}/elixir-1.18.4
pushd ..
cp -a elixir-1.18.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747836001
