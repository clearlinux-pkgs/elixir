...
Version  : 1.16.1
Release  : 28
URL      : https://github.com/elixir-lang/elixir/archive/v1.16.1/elixir-1.16.1.tar.gz
Source0  : https://github.com/elixir-lang/elixir/archive/v1.16.1/elixir-1.16.1.tar.gz
...
%prep
%setup -q -n elixir-1.16.1
cd %{_builddir}/elixir-1.16.1
pushd ..
cp -a elixir-1.16.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706715467
