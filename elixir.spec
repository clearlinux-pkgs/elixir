...
Version  : 1.15.0
Release  : 19
URL      : https://github.com/elixir-lang/elixir/archive/v1.15.0/elixir-1.15.0.tar.gz
Source0  : https://github.com/elixir-lang/elixir/archive/v1.15.0/elixir-1.15.0.tar.gz
...
%prep
%setup -q -n elixir-1.15.0
cd %{_builddir}/elixir-1.15.0
pushd ..
cp -a elixir-1.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687204957
