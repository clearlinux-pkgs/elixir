...
Version  : 1.13.3
Release  : 14
URL      : https://github.com/elixir-lang/elixir/archive/v1.13.3/elixir-1.13.3.tar.gz
Source0  : https://github.com/elixir-lang/elixir/archive/v1.13.3/elixir-1.13.3.tar.gz
...
%prep
%setup -q -n elixir-1.13.3
cd %{_builddir}/elixir-1.13.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645654789
...
cp %{_builddir}/elixir-1.13.3/LICENSE %{buildroot}/usr/share/package-licenses/elixir/a6a5418b4d67d9f3a33cbf184b25ac7f9fa87d33
