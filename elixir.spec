...
Version  : 1.10.2
Release  : 9
URL      : https://github.com/elixir-lang/elixir/archive/v1.10.2/elixir-1.10.2.tar.gz
Source0  : https://github.com/elixir-lang/elixir/archive/v1.10.2/elixir-1.10.2.tar.gz
...
%prep
%setup -q -n elixir-1.10.2
cd %{_builddir}/elixir-1.10.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584381934
...
cp %{_builddir}/elixir-1.10.2/LICENSE %{buildroot}/usr/share/package-licenses/elixir/a6a5418b4d67d9f3a33cbf184b25ac7f9fa87d33
cp %{_builddir}/elixir-1.10.2/NOTICE %{buildroot}/usr/share/package-licenses/elixir/579fc93a4227c9eb0e1263ac0652074b080cbba5
