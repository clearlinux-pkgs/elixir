...
Source0  : https://github.com/elixir-lang/elixir/archive/v1.14.2/elixir-1.14.2.tar.gz
...
%prep
%setup -q -n elixir-1.14.2
cd %{_builddir}/elixir-1.14.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672171328
