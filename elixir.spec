...
Version  : 1.16.2
Release  : 29
URL      : https://github.com/elixir-lang/elixir/archive/v1.16.2/elixir-1.16.2.tar.gz
Source0  : https://github.com/elixir-lang/elixir/archive/v1.16.2/elixir-1.16.2.tar.gz
...
%prep
%setup -q -n elixir-1.16.2
cd %{_builddir}/elixir-1.16.2
pushd ..
cp -a elixir-1.16.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710166874
...
cp %{_builddir}/elixir-%{version}/NOTICE %{buildroot}/usr/share/package-licenses/elixir/e8f8b9a4a1ee805f64a05af75ec7c662aea49ff9 || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
