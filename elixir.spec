...
Version  : 1.17.2
Release  : 33
URL      : https://github.com/elixir-lang/elixir/archive/v1.17.2/elixir-1.17.2.tar.gz
Source0  : https://github.com/elixir-lang/elixir/archive/v1.17.2/elixir-1.17.2.tar.gz
...
%prep
%setup -q -n elixir-1.17.2
cd %{_builddir}/elixir-1.17.2
pushd ..
cp -a elixir-1.17.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720462705
