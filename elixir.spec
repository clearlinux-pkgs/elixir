...
Source0  : https://github.com/elixir-lang/elixir/archive/v1.13.4/elixir-1.13.4.tar.gz
...
%prep
%setup -q -n elixir-1.13.4
cd %{_builddir}/elixir-1.13.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649350095
...
cp %{_builddir}/elixir-1.13.4/LICENSE %{buildroot}/usr/share/package-licenses/elixir/a6a5418b4d67d9f3a33cbf184b25ac7f9fa87d33
cp %{_builddir}/elixir-1.13.4/NOTICE %{buildroot}/usr/share/package-licenses/elixir/e8f8b9a4a1ee805f64a05af75ec7c662aea49ff9
...
/usr/share/package-licenses/elixir/e8f8b9a4a1ee805f64a05af75ec7c662aea49ff9
