...
Version  : 1.18.3
Release  : 37
URL      : https://github.com/elixir-lang/elixir/archive/v1.18.3/elixir-1.18.3.tar.gz
Source0  : https://github.com/elixir-lang/elixir/archive/v1.18.3/elixir-1.18.3.tar.gz
...
%prep
%setup -q -n elixir-1.18.3
cd %{_builddir}/elixir-1.18.3
pushd ..
cp -a elixir-1.18.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741280405
