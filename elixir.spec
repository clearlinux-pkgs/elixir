...
Version  : 1.14.3
Release  : 17
URL      : https://github.com/elixir-lang/elixir/archive/v1.14.3/elixir-1.14.3.tar.gz
Source0  : https://github.com/elixir-lang/elixir/archive/v1.14.3/elixir-1.14.3.tar.gz
...
%prep
%setup -q -n elixir-1.14.3
cd %{_builddir}/elixir-1.14.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674688419
